...
- [AIDL](android/aidl.md)
  ...
  - [Service API](android/aidl/service-bindings.md)
  - [Service](android/aidl/service.md)
  - [Server](android/aidl/server.md)
  - [Deploy](android/aidl/deploy.md)
  - [Client](android/aidl/client.md)
  - [Changing API](android/aidl/changing-definition.md)
  - [Updating Implementations](android/aidl/changing-implementation.md)
